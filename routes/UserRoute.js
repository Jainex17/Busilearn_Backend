...
router.route("/createreview").post(isAuthenticatedUser,createReview);
...
router.route("/instructor/payments").get(isAuthenticatedInstructor,getInstructorPayments);
